...
public class AccommodationAttachController {
...
//    	AccommodationAttach attach = accommodationAttachRepository.findById(fileNo)
...
//
//        try {
//        	accommodationAttachService.deleteAttachById(id);
